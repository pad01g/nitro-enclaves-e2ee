...
export class ContextProvider {
  ...
  static setAuthUser(): void {
    ContextProvider.set(ContextProvider.authUserKey, null);
  }
  ...
  static getAuthUser(): undefined {
    return ContextProvider.get<undefined>(ContextProvider.authUserKey);
  }
}
